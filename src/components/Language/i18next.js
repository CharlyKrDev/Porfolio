      ...
      es: {
        translation: {
          ...
          skills: {
            ...
            skillsP2:
              "Hablo español de forma nativa, ingles nivel B2 y estoy aprendiendo italiano A2-B1.",
            skillsP3:
      ...
      en: {
        translation: {
          ...
          skills: {
            skillsH2: "Skills",
            skillsP2:
              "I am a native Spanish speaker, have a B2 level of English, and I am learning Italian at an A2-B1 level.",
            skillsP3:
      ...
      it: {
        translation: {
          ...
          skills: {
            skillsH2: "Competenze",
            skillsP2:
              "Parlo spagnolo come lingua madre, ho un livello B2 di inglese e sto imparando l' italiano a un livello A2-B1.",
            skillsP3:
