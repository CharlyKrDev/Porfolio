...
export const FormContact = () => {
  ...
  const iconsStyle = 'flex items-center sm:text-md text-sm  hover:bg-[#ffffff30] hover:rounded-md transition-all ease-in-out duration-300 gap-2 p-1'
  const form = useRef();
...
<section className='h-auto flex flex-col gap-4 p-2 text-wrap w-auto ml-2 m-auto'>
    <h3 className='sm:text-2xl text-lg font-semibold text-[#7FDBFF]/70'>{t('form.formH3')} </h3> <span className='sm:text-4xl text-3xl text-[#7FDBFF]/70'><PiHandshake /></span>
    ...
    <ul className='flex flex-col gap-2'>
        ...
        <li>
          <h2 className='flex items-center sm:text-xl text-md'>{t('form.formH2')}</h2>
        </li>
        <li>
